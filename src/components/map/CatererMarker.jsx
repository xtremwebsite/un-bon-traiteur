...
export default function CatererMarker({ item }) {
  return <Marker position={[item.latitude, item.longitude]} icon={catererIcon}><Popup className="caterer-bento-popup" minWidth={0} maxWidth={660} autoPanPadding={[24, 24]}><CatererMapCard item={item}/></Popup></Marker>;
}