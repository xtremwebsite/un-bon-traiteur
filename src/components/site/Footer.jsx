...
export default function Footer() {
  return <footer className="mt-16 bg-primary text-primary-foreground">
    <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-4">
      ...
      <div><p className="font-semibold">Professionnels</p><Link className="mt-3 block text-sm" to="/espace-traiteur">Espace traiteur</Link><Link className="mt-2 block text-sm" to="/inscription-extra">Inscription Extra</Link><Link className="mt-2 block text-sm" to="/referencement">Fonctionnement du classement</Link></div>
