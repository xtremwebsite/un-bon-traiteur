...
export default function ProOpportunities(){
  const[data,setData]=useState({items:[],subscribed:false,profile:null});const[loading,setLoading]=useState(true);const[filters,setFilters]=useState({search:'',kind:'all',eventType:'all',radius:1000});
